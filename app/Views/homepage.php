...
<body>
    ...
    <div class="container-fluid">
                ...
                <div id="carouselExampleCaptions" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= base_url('images/carousel1.jpg')?>" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item">
                            <img src="<?= base_url('images/carousel2.jpg')?>" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            <img src="<?= base_url('images/carousel3.jpg')?>" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="col-12" style="background-image: url('images/background-container.svg')">
        </div>
        </div>
    </div>
    <!--container-->
